...
import { Menu, X, Mail, Target, Users, Award, Zap, Phone } from "lucide-react"
      ...
      <div className="min-h-screen bg-slate-50 font-inter">
        ...
        <section id="propuesta-valor" className="py-12 lg:py-20 bg-aukan-gray-green">
          <div className="container mx-auto px-4 lg:px-8 xl:px-12">
            <FadeIn>
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-3 uppercase">{t("valueProposal.title")}</h2>
                <p className="text-xl text-slate-200 text-justify max-w-4xl mx-auto">
                  {t("valueProposal.description")}
                </p>
              </div>
            </FadeIn>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
              {[
                {
                  title: t("valueProposal.pillar1Title"),
                  description: t("valueProposal.pillar1Description"),
                  icon: Target,
                  delay: 100,
                },
                {
                  title: t("valueProposal.pillar2Title"),
                  description: t("valueProposal.pillar2Description"),
                  icon: Users,
                  delay: 200,
                },
                {
                  title: t("valueProposal.pillar3Title"),
                  description: t("valueProposal.pillar3Description"),
                  icon: Award,
                  delay: 300,
                },
                {
                  title: t("valueProposal.pillar4Title"),
                  description: t("valueProposal.pillar4Description"),
                  icon: Zap,
                  delay: 400,
                },
              ].map((pillar, index) => {
                  ...
                  <FadeIn key={index} delay={pillar.delay}>
                    <div className="text-center group">
                      <div className="bg-white/10 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6 transition-all duration-300 group-hover:scale-110 group-hover:bg-white/20">
                        <IconComponent className="w-10 h-10 text-aukan-lime-green transition-all duration-300 group-hover:scale-110" />
                      </div>
